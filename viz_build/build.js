(function webpackUniversalModuleDefinition(root, factory) {
  if(typeof exports === 'object' && typeof module === 'object')
    ...
    exports["hello_world_react"] = factory();
  else
    root["hello_world_react"] = factory();
})(window, function() {
...
looker.plugins.visualizations.add({
  ...
  create: function create(element, config) {
    ...
    container.className = "hello-world-vis"; // Create an element to contain the text.
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    this.clearErrors(); // Throw some errors and exit if the shape of the data isn't what this chart needs
